...
in the presence of inhomogeneities, nonzero means and linear constraints. The 
goal is to derive a best guess for a covariance function.
...
# v) Affine constraints: gamma[0,0]=b
...
Kernel_inference_inhomogeneous(x_measured_list,gamma_0,Psi_list,r, G_list=G_list, A=A, max_iter=20)
