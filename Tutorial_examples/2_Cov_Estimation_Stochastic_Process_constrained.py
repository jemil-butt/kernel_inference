...
without the presence of means or inhomogeneities to derive a best guess for a 
covariance function.
...
# iv) Affine constraints: gamma[0,0]=b
...
sys.path.append("..")
import KI
beta, mu_beta, gamma, C_gamma, KI_logfile=KI.Kernel_inference_homogeneous(x_measured,gamma_0,Psi,r, A= A)
