...
nor nonzero mean or inhomogeneities complicate the procedure. This produces a figure 
showcasing  the kernel inference procedure and its uses as detailed in the case 
example nr 1 which deals with uncnstrained kernel inference.
...
K_constraint=spla.block_diag(K_sqexp_mod,np.zeros([3,3]))
